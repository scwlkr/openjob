...
- [Define the v1 Done Bar and Build Order](issues/09-define-the-v1-done-bar-and-build-order.md) — OpenJob ships its complete Firebase-backed `/api/v1` backend as v0.0.5, then the full web and installable command CLI together as v0.1.0 after maintained Preview fixture proof and separate real-provider acceptance.
