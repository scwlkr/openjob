...
Requires macOS and Node.js 22.13 or newer. Install OpenJob v0.1.0 from GitHub:

```bash
npm install --global https://github.com/scwlkr/openjob/releases/download/v0.1.0/openjob-0.1.0.tgz
```
