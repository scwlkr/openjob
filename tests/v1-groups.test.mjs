...
test("a Group GET returns 410 when deletion wins before its final active check", async () => {
  ...
  const responsePromise = api.fetch(
    new Request("https://openjob.test/api/v1/groups/grp_racing"),
  );
  await readStarted;
