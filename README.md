...
Install OpenJob v0.3.5 from GitHub with one command:

```bash
npm install --global https://github.com/scwlkr/openjob/releases/download/v0.3.5/openjob-0.3.5.tgz
```
...
such as `0.3.5-rc.1`. Publishing creates a draft with a versioned CLI artifact and checksum
